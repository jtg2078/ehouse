...
- (void)viewDidLoad
{
    ...
    items = [[NSMutableArray alloc] initWithObjects:section1, nil];
    
    NSString *title = @"我的專區";
    titleItems = [[NSMutableArray alloc] initWithObjects:title, nil];
    ...
    img = [[NSMutableArray alloc] initWithObjects:imgA, nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageView.image = [UIImage imageNamed:[[img objectAtIndex:indexPath.section] objectAtIndex:indexPath.row]];
