...
@implementation FavoriteMessageParser
...
didStartElement:(NSString *)elementName 
 ...
 qualifiedName:(NSString *)qualifiedName	
	...
	if([elementName isEqualToString:@"MessagePortletViewOfViewMsgMemberAllMessage"]) {
 ...
 qualifiedName:(NSString *)qName {
	...
	if ([elementName isEqualToString:@"Message"]) {
		...
		if ([elementName isEqualToString:@"Title"]) {
            ...
            if ([trimmedString isEqualToString:@"N"])
                currentMessage.IsImportant = NO;
            else
                currentMessage.IsImportant = YES;
		}
		else if ([elementName isEqualToString:@"MsgDate"]) {
