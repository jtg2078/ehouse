...
@implementation CustomizeMessageParser
...
didStartElement:(NSString *)elementName 
 ...
 qualifiedName:(NSString *)qualifiedName	
	...
	if([elementName isEqualToString:@"ArrayOfPortalCalendar"]) {
		
		currentMessages = [[NSMutableArray alloc] init];
	}
	else if([elementName isEqualToString:@"PortalCalendar"]) {
...
- (void)parser:(NSXMLParser *)parser 
 ...
 qualifiedName:(NSString *)qName {
	...
	if ([elementName isEqualToString:@"PortalCalendar"]) {
